...
const APP_CMD = createEnum({
  ...
  UPDATE_LAYOUT: 38,
  UPDATE_LAYOUT_SETTINGS: 39,
  UPDATE_ATTRIBUTE_SETTINGS: 40,
  UPDATE_NETWORK_SETTINGS: 41,
  DELETE_USER_PROFILE: 42,
  ALTER_DAO_AUTHORITY: 43,
  CREATE_BOOKMARK: 44,
  DELETE_BOOKMARK: 45,
  MARK_NOTIFICATIONS_AS_READ: 46
});
